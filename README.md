...
DEFCON5 -> Least secure, can use a simple password, mostly to keep people from snooping. Has secure argon2 parameters for both memory and iters, but MUCH lower than defcon1, much faster fetch time.<br>
